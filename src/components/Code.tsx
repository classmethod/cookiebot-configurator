...
function Code() {
    ...
    <>
        ...
        <TextInput
          name="directory"
          label="Directories you do NOT want the banner to appear (multiple directories with cumma, e.g. /wp-admin, /member/*)"
          description="Cookiebot still scan all the directories belong to the domain"
          onChange={(e) => inputChange(e, "blockmode")}
